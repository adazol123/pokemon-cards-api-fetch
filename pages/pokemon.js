        ...
        <Layout title={ name} >
            ...
            <Flex flex={1} flexDirection='column' alignItems='center' justifyContent='center'>
                ...
                <Flex flexDirection='column' width='full'>
                    ...
                    <Text px={4} mt={3}><span>Weight: </span> {weight} KG</Text>
                    <Text px={4} ><span>Height: </span> {height} CM</Text>
                </Flex>
                <Flex flexDirection='column' width='full'>
                 <Heading mt={15}  fontSize='2xl' >Ability</Heading> 
                    <HStack my={3} spacing={3}>
                        {abilities.map(( mainAbility ) => (
                            // const { ability: {name: abiName}} = mainAbility;
                            <Tag key={mainAbility.ability.name}
                            size="lg" colorScheme='yellow' borderRadius="full" textTransform='capitalize'
                            px={4}
